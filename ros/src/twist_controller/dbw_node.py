...
import rospy
from dbw_mkz_msgs.msg import BrakeCmd, SteeringCmd, SteeringReport, ThrottleCmd
...
class DBWNode(object):
    ...
    def twist_cb(self, msg):
        ...
        rospy.loginfo('twist_cb:%s', msg)

    def velocity_cb(self, msg):
        self.current_vel = msg.twist.linear.x
        rospy.loginfo('velocity_cb:%s', msg)
    ...
    def loop(self):
        ...
        while not rospy.is_shutdown():
            ...
            if self.dbw_enabled:
                ...
                rospy.loginfo('throttle=%f brake=%f steering=%f', self.throttle, self.brake, self.steering)
            rate.sleep()
